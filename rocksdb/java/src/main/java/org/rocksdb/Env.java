...
public abstract class Env extends RocksObject {
  ...
  /**
   * <p>Returns the ZenFS environment.</p>
   *
   * @return the ZenFS {@link org.rocksdb.RocksEnv} instance.
   */
  public static Env getZenFS() {
    return ZenFS_ENV;
  }
  ...
  private static native long getZenFSEnvInternal();
