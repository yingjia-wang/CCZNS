...
class IndexBuilder {
 public:
  ...
  // for RCZNS
  virtual void FindShortestInternalKey([[maybe_unused]] std::string* last_key_in_current_block,
                                        [[maybe_unused]] const Slice* first_key_in_next_block) {}
...
class ShortenedIndexBuilder : public IndexBuilder {
 public:
  ...
  virtual void FindShortestInternalKey(std::string* last_key_in_current_block,
                     const Slice* first_key_in_next_block) override {
  ...
  virtual void AddIndexEntry(std::string* last_key_in_current_block,
    ...
    // printf("delta? %d sz %lu %lu %lu %lu\n", use_value_delta_encoding_, 
    //   encoded_entry.size(), delta_encoded_entry.size(),
...
#ifndef NDBG
    printf("in IndexBuilder::Finish index_size_ %lu\n", index_size_);
#endif
    return Status::OK();
  }
